...
public class DrawingDelver extends PApplet {
...
// POLYGON/RECTANGLE
public boolean polyRect(ArrayList<PVector> vertices, float rx, float ry, float rw, float rh) {
...
// RECTANGLE/RECTANGLE
public boolean rectRect(float x1,float y1, float w1, float h1, float x2,float y2, float w2, float h2){
...
class Collectable extends Entity {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "DrawingDelver" };
    if (passedArgs != null) {
